...
This file provides essential context for AI coding assistants (Codex, Gemini, etc.) working on this project.
...
├── AGENTS.md / GEMINI.md           # This file (AI assistant context)
└── README.md
```
