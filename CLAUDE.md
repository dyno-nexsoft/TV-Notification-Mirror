...
- TV emulator (x86_64) is supported by `flutter run`: `fvm flutter run -d emulator-5556` (in `tv/`).
...
# Run TV app on TV emulator
fvm flutter run -d emulator-5556     # run in tv/
